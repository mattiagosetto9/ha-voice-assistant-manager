...
- Removed redundant "Voice Assistant Manager" h1 title from the page — the sidebar label covers desktop and the new mobile topbar covers narrow viewports, matching the convention of other HA panels
